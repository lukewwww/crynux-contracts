...
const [withdrawalTxHash] = expectPositionalArgs(
  1,
  'npx tsx deployments/primary/scripts/crynux-on-base/claim-crynux-withdrawal.ts <withdrawalTxHash>',
);
    ...
    JSON.stringify(
      {
        ...
        status: statusName,
        readyToExecute: true,
        action: `Executing withdrawal on ${primaryRuntime.names.base}.`,
      },
      null,
      2,
    ),
