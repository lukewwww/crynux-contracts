...
import { getDeployerAccount, orbitChainPublicClient, assertAddress, deploymentConfig } from './common.js';

expectPositionalArgs(0, 'npx tsx deployments/primary/scripts/crynux-on-base/set-l2-tx-fee-receiver.ts');
