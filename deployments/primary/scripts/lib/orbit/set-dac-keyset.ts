...
import { orbitRuntime, getDacCoreContracts, getDacKeyset, getDeployerAccount, parentChainPublicClient } from './runtime.js';

expectPositionalArgs(0, `npx tsx deployments/primary/scripts/${orbitRuntime.scriptDir}/set-dac-keyset.ts`);
