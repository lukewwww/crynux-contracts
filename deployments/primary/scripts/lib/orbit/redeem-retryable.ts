...
const [parentTxHash, retryableCreationId, gasLimitInput, maxFeePerGasInput, maxPriorityFeePerGasInput] = expectAtLeastPositionalArgs(
  2,
  `npx tsx deployments/primary/scripts/${orbitRuntime.scriptDir}/redeem-retryable.ts <parentTxHash> <retryableCreationId> [gasLimit] [maxFeePerGasGwei] [maxPriorityFeePerGasGwei]`,
);
